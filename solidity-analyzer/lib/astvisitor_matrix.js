...
var FindAllFuntions = function () {
    ...
    this.preOrderVisitFunctionDeclaration = function(node) {
        ...
        funcs.push(currentContract + ':' + node.name);
    }
...
util.inherits(FindAllFuntions, ASTVisitor);
...
module.exports = {
    ...
    // Matrix
    findAllFunctions: function(){return new FindAllFuntions();}
};
